        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold leading-tight text-gray-800">
                    Persyaratan Dokumen - {{ $kost->name }}
                </h2>
                <p class="mt-1 text-sm text-gray-600">
                    Atur dokumen apa saja yang harus disiapkan penyewa saat menyewa kost ini
                </p>
            </div>
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <select id="document_type" name="document_type" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('document_type') border-red-300 @enderror">
                                ...
                                <div>
                                    ...
                                    <select id="is_required" name="is_required" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('is_required') border-red-300 @enderror">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="reason" name="reason" value="{{ old('reason') }}" maxlength="500"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('reason') border-red-300 @enderror"
                                                ...
                                                <td colspan="3" x-show="editing" class="px-6 py-4">
                                                    <form method="POST" action="{{ route('admin.kosts.document-requirements.update', [$kost, $requirement]) }}" class="space-y-3">
                                                        ...
                                                        <div class="flex justify-end space-x-2">
                                                            ...
                                                            <button type="submit"
                                                                class="rounded-md border border-transparent bg-indigo-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-indigo-700">
                                                                Simpan
                                                            </button>
                                                        </div>
                                                    </form>
